...
public class JSONConverter {
	 ...
	 */
	public static <T> T unmarshal(Class<T> type, byte[] message) throws JSONException {
		try {
	 ...
	 */
	public static String marshal(Object object) throws JSONException {
		try {
	...
	public <T> boolean isOfType(Class<T> type, byte[] message) {
		...
		} catch (JSONException ex) { // ex expected, not used
			domainObject = null;
			return false;
		}
	}
