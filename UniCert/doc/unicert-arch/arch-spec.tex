...
The rest of the process is issuance of the certificate. This works in the same way independently of the identity provider used. The process is shown in \Cref{fig:request_process}
...
%\caption{Certificate request process}
%\label{fig:request_process}
%\end{figure}
