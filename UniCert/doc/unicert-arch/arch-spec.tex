...
For the authentication request, information displayed in \Cref{t:authreq} must be sent. \Cref{t:authresp} shows the information returned after successful authentication.
...
For the certificate request, some information must be provided. For a RSA certificate, information displayed in \Cref{t:rsa} must be sent, for a discrete logarithm certificate \Cref{t:dlog} shows them.
