...
//					if(countSR>rules[j].getUpperBound()){
//						return true;
//					}
//				}            
//			}
...
//					if(value != undefined){
//						//if greater than upper bound => error
//						if(value > rules[i].getUpperBound()){
//							return true;
//						}
//					}
//				}
...
//			//loop through the rules
//			for(var i=0; i<rules.length; i++){
//				var lowerBoundSR = rules[i].getLowerBound();
...
//							if(value < rules[i].getLowerBound()){
//								return true;
//							}
//						}
...
//			for(var i=0; i<rules.length; i++){
//				var sumRule = rules[i];
//				var lowerBoundSR = sumRule.getLowerBound();
//				//check only for rules whose limit is more than 0
//				if(lowerBoundSR>0){
//					var ids = sumRule.getChoiceId();
//					var countSR = 0;
//
//					//loop through the concerned ids
//					for(var j=0; j<ids.length; j++){
...
//						}
//
//						if(countSR>=rules[i].getLowerBound()){
//							break;
//						}
//					}
//					//if smaller than lower bound => error
