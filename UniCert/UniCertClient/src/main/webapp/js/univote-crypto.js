...
(function(window) {
	...
	function Crypto() {
		...
		/**
		 * Generates a secret key. A secret key is a random number in Zq in
		 * the Schnorr system.
		 *
		...
		this.generateSecretKey = function() {
			...
			var sk = leemon.randBigIntInZq(schnorr.q);
			return sk;
		}
		 ...
		 */
		this.computeVerificationKeyAsync = function(sk, doneCb, progressCb) {

			leemon.powModAsync(schnorr.g, sk, schnorr.p, progressCb, doneCb);
		}
