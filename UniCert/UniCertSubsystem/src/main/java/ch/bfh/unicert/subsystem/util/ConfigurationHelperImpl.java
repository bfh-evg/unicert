...
//    }
    ...
    public void init() throws CertificateCreationException {
        ...
        try {
            ...
            props = (Properties) ic.lookup("registrationProps");
        } catch (NamingException ex) {
            logger.log(Level.SEVERE, "JNDI lookup for 'registrationProps' failed. Exception: {0}",
                    new Object[]{ex});
            throw new CertificateCreationException("Fail to load configuration");
        }
...
//        this.prime = retrieveBigIntegerProperty(props, "prime");
//        this.groupOrder = retrieveBigIntegerProperty(props, "groupOrder");
//        this.generator = retrieveBigIntegerProperty(props, "generator");
        ...
        if (isExternal) {
            ...
            try {
                ...
                throw new CertificateCreationException("Failed to load keystore");
            }
            InputStream in;
            try {
            ...
            try {
                ...
                throw new CertificateCreationException("Failed to load keystore entry");
            }
...
//     * @return the value of the property
//     */
//    private BigInteger retrieveBigIntegerProperty(Properties props, String propertyName) {
//        String propertyValue = props.getProperty(propertyName);
//        if (propertyValue == null) {
//            logger.log(Level.SEVERE,
//                    "Could not retrieve global JNDI property: {0}.", new Object[]{propertyName});
...
//                    "Retrieved global JNDI property: {0}.", new Object[]{propertyName});
//        }
//        return new BigInteger(propertyValue, ConfigurationHelper.RADIX);
//    }
