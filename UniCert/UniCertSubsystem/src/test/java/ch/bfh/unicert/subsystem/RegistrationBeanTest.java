...
public class RegistrationBeanTest {
	...
	ZMod Z_q = G_q.getZModOrder();
        ...
        String hashedAppId = applicationId;
        try{
            ...
            hashedAppId = Base64.encode(hashFunction.apply(sm.getElement(applicationId)).getByteArray().getAll());
        }catch (Exception e){}
        ...
        //TODO uncomment when hashing works
